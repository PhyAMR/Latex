...
\end{dem}
\begin{dem}[Equilibrio Mecánico y Térmico]{}
  
\end{dem}
\begin{dem}[Ecuación de Estado del Interior Estelar]{}
  
\end{dem}
\begin{dem}[Modelos Politrópicos]{}
  
\end{dem}
\begin{dem}[Transporte de Energía en los Interiores Estelares]{}
  
\end{dem}
\begin{dem}[Nucleosíntesis Estelar]{}
  
\end{dem}
\begin{dem}[Modelos Estelares y Estabilidad Estelar]{}
  
\end{dem}
\begin{dem}[Introducción a la Evolución Estelar]{}
  
\end{dem}
\begin{dem}[Formación Estelar]{}
  
\end{dem}
\begin{dem}[Secuencia Principal]{}
  
\end{dem}
\begin{dem}[Evolución Post-secuencial Principal]{}
  
\end{dem}
\begin{dem}[Últimas Fases de la Evolución Estelar]{}
